...
public class StartAction extends Action {
    ...
    * @param controller
    */
   public StartAction(MainFrame mainFrame, IMenuController controller, Integer gameState, StringBuilder player1,
                      StringBuilder player2, IInitGameController initC) {
