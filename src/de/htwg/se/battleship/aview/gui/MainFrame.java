...
import de.htwg.se.battleship.util._observer.Observer;
...
public abstract class MainFrame extends JFrame implements WindowListener, KeyListener, ActionListener, Observer {
   ...
   /* (non-Javadoc)
    * @see de.htwg.se.battleship.aview.gui.impl.MainFrame#update(de.htwg.se.battleship.util._observer.Event)
    */
   @Override
